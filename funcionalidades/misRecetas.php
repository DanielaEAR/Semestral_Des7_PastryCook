...
?>   
    ...
    <br>
    <div class="subCrear">
        <a href="crear_EditarRecetas.php"> <button class="btnCrear">Crear Receta
...
?>  
    <div class="tarjetaPadre">
        <div class="tarjeta">
            ...
            <div class="sub3">
                <div class="subEditar">
                    <a href="crear_EditarRecetas.php?idR=<?php print($resMisRecetas['id_R'])?>"> <button class="btnEditar">Editar</button> </a>
                </div>
